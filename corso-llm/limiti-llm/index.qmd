...
La risposta sarà qualcosa tipo "Ci sono 120 puntini". Riprovate: "190", riprovate ancora vi darà "99", poi "125". Quasi sempre sicurissima, quasi sempre sbagliata. (Sono esattamente 115 puntini).
...
L'intera sequenza di 115 puntini viene rappresentata da soli 4 token! L'LLM non vede singoli puntini ma gruppi. Non può contarli perché dal suo punto di vista non esistono individualmente.

Problemi simili emergono con domande tipo "Quante lettere 'e' ci sono in 'eccellente'?"

\vspace{0.5cm}

![Figura 1: Tokenizzazione dei puntini](immagini/llm-tokens-dots.png){width=85% fig-align="center"}
...
![Figura 2: Esempio di calcolo matematico con LLM](immagini/math_LLM_example.png){width=89% fig-align="center"}
...
![Figura 3: Allucinazioni LLM](immagini/allucinazioni_llm.png){width=100% fig-align="center"}
...
![Figura 4: Kahneman Book](immagini/kahneman_book.jpg){width=83% fig-align="center"}
...
![Figura 5: On the Biology of LLM](immagini/On_the_Biology_of_LLM.png){width=83% fig-align="center"}
...
![Figura 6: Memento Poster](immagini/memento_poster.jpg){width=62% fig-align="center"}

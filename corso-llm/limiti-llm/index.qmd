...
![Figura 1: Esempio di calcolo matematico con LLM](immagini/math_LLM_example.png){width=74% fig-align="center"}
...
![Figura 2: Allucinazioni LLM](immagini/allucinazioni_llm.png){width=85% fig-align="center"}
...
![Figura 3: Kahneman Book](immagini/kahneman_book.jpg){width=69% fig-align="center"}
...
![Figura 4: On the Biology of LLM](immagini/On_the_Biology_of_LLM.png){width=69% fig-align="center"}
...
![Figura 5: Memento Poster](immagini/memento_poster.jpg){width=52% fig-align="center"}

...
![Struttura di una rete neurale](immagini/artificial_neural_network.png){width=85% fig-align="center"}
...
![Vettore 2D](immagini/2d_vector.png){width=60% fig-align="center"}

\begin{center}
\Large{\textbf{Vettore in uno spazio a tre dimensioni}}
\end{center}

![Vettore 3D](immagini/3d_vector.png){width=60% fig-align="center"}
...
![Attention Heatmap](immagini/attention_llm.png){width=85% fig-align="center"}
